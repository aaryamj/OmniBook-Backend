...
const htmlProviderEmailLogic = `
    public void sendProviderInvite(String to, String token, String clinicName) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            
            helper.setTo(to);
            helper.setSubject("Activate Your Provider Account: " + clinicName);
            ...
            String htmlContent = "<!DOCTYPE html>" +
                ...
                "            <p class=\\"message\\">Welcome to OmniBook. You have been invited to join <strong>" + clinicName + "</strong> as a Service Provider. Please activate your account to view your schedule and patients.</p>" +
...
content = content.replace(/}\s*$/, htmlProviderEmailLogic.trim() + '\n}\n');
fs.writeFileSync(path, content);
console.log('EmailService Provider logic added!');
